      ...
      for (const opt of value.aggregateOptions) {
        ...
        if (typeof t === 'undefined') {
          ...
          if (t.profile && t.profile.length > 0) {
            ...
            profiles.forEach(p => MVH.addTypeProfile(extension, ssValue.type, t.code, p));
            ...
            targetProfiles.forEach(tp => MVH.addTypeTargetProfile(extension, ssValue.type, t.code, tp));
          } else {
