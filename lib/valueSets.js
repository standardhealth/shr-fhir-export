...
class ValueSetExporter {
  ...
  exportValueSet(valueSet) {
    ...
    fhirVS.name = fhirVS.title = `${this._config.projectShorthand} ${valueSet.identifier.name} ValueSet`;
...
<p><b>${projectShorthand} ${common.escapeHTML(valueSet.identifier.name)} ValueSet</b></p>
