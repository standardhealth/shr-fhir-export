...
`<div xmlns="http://www.w3.org/1999/xhtml">
  ...
  toSingleType(value) {
    ...
    if (id.equals(CODEABLE_CONCEPT_ID) || id.equals(CODING_ID)) {
      ...
      const profileURL = common.fhirURL(id, this._config.fhirURL, 'model');
      this.resolve(profileURL);
      return { code: 'Reference', targetProfile: profileURL };
    }
    const profileURL = common.fhirURL(id, this._config.fhirURL, 'model');
    this.resolve(profileURL);
    return { code: profileURL };
  }
