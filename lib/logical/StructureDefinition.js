...
class StructureDefinition {
  ...
  /**
   * @returns {{type: string, expression: string}[]} context
   */
  get context() { return this._context; }
  /**
   * @param {{type: string, expression: string}[]} context
   */
...
const PROPS = [ 'id', 'meta', 'implicitRules', 'language', 'text', 'contained', 'extension',
  ...
  'fhirVersion', 'mapping', 'kind', 'abstract', 'context', 'contextInvariant', 'type',
