...
class CodeSystemExporter {
  ...
  exportCodeSystem(codeSystem) {
    ...
    fhirCS.name = fhirCS.title = `${this._config.projectShorthand} ${codeSystem.identifier.name} CodeSystem`;
...
<p><b>${projectShorthand} ${common.escapeHTML(codeSystem.identifier.name)} CodeSystem</b></p>
