...
`<div xmlns="http://www.w3.org/1999/xhtml">
  ...
  findMatchingType(sourceValue, targetTypes, sourceIdentifier=null) {
    ...
    if (sourceIdentifier != null) {
      sourceId = common.choiceFriendlyEffectiveIdentifier(sourceValue, sourceIdentifier);
    } else {
      sourceId = common.choiceFriendlyEffectiveIdentifier(sourceValue);
    }
    const sourceMap = this._specs.maps.findByTargetAndIdentifier(this._target, sourceId);
    if (sourceMap == null) {
      return;
    }
