...
`<div xmlns="http://www.w3.org/1999/xhtml">
  ...
  checkMappedAndConstrained(profile, path) {
    ...
    } else if (this.elementTypeUnconstrainedCode(profile, codeEl) && !this.elementTypeIsPrimitive(codeEl)) {
  ...
  elementTypeIsPrimitive(el) {
    return el.type && el.type.some(t => ['boolean',
                                         'integer',
                                         'string',
                                         'decimal',
                                         'uri',
