...
const disableError = {
  invalidTarget: true,
  externalCR: true,
  wideCardMapping: true,
  wideCardFieldMapping: true,
  ambiguousCardMapping: true,
  impossibleAggregateCardMapping: true,
  knownTypeIncompatibility: true,
  otherTypeIncompatibility: true
};
