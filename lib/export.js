...
=======
      ...
      this._profileIndicators.set(profileID, new ProfileIndicators(profileURL, map.targetItem));
>>>>>>> 56e3bee... added support for configuration file
...
`<div xmlns="http://www.w3.org/1999/xhtml">
  <p><b>${this._config.projectShorthand} ${common.escapeHTML(map.identifier.name)} Profile</b></p>
  <p>${common.escapeHTML(this.getDescription(map.identifier))}</p>
  <p><b>${this._config.projectShorthand} Mapping Summary</b></p>
